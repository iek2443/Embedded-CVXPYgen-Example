...
extern void cpg_update_lambda_cost(cpg_float val);
extern void cpg_update_x_curr(cpg_float val);
extern void cpg_update_k_gain(cpg_float val);
extern void cpg_update_x_ref(cpg_float val);
