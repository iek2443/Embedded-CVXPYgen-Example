...
(cpg_float)0.97457513696789466184,
(cpg_float)0.06212074286607434381,
(cpg_float)-0.81387325738502636074,
(cpg_float)1.00000000000000000000,
};

// Sparse mappings from user-defined to canonical parameters
cpg_int canon_P_map_i[2] = {
4,
0,
};
cpg_int canon_P_map_p[3] = {
0,
1,
2,
};
cpg_float canon_P_map_x[2] = {
(cpg_float)2.00000000000000000000,
(cpg_float)2.00000000000000000000,
};
cpg_csc canon_P_map = {canon_P_map_p, canon_P_map_i, canon_P_map_x, 2};

cpg_int canon_A_map_i[4] = {
4,
2,
4,
4,
};
cpg_int canon_A_map_p[5] = {
0,
1,
2,
3,
...
cpg_float canon_A_map_x[4] = {
(cpg_float)-1.00000000000000000000,
(cpg_float)1.00000000000000000000,
(cpg_float)-1.00000000000000000000,
(cpg_float)1.00000000000000000000,
};
cpg_csc canon_A_map = {canon_A_map_p, canon_A_map_i, canon_A_map_x, 4};
...
cpg_float canon_b[3] = {
(cpg_float)-1.78844839435292102259,
(cpg_float)0.00000000000000000000,
(cpg_float)10.00000000000000000000,
};
