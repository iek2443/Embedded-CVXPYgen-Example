...
// Parameter deltas
typedef struct {
  cpg_float    *lambda_cost;   // Delta of your parameter lambda_cost
  cpg_float    *x_curr;    // Delta of your parameter x_curr
  cpg_float    *k_gain;    // Delta of your parameter k_gain
...
// SCS solution
extern cpg_float scs_x[2];
extern cpg_float scs_y[3];
extern cpg_float scs_s[3];
